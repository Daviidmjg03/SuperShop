...
namespace SuperShop.Prism.ItemViewModels
{
    public class ProductItemViewModel : ProductResponse
    {
        ...
        private DelegateCommand _selectProdcutCommand;
        public ProductItemViewModel(INavigationService navigationService)
        {
            _navigationService = navigationService;
        }

        public DelegateCommand SelectProductCommand => _selectProdcutCommand ?? (_selectProdcutCommand = new DelegateCommand(SelectProductAsync));
